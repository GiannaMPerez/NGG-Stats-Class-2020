% Exercise 1 for Binomial Distribution 
p = 0.2;                       
n = 10;                
k = 0:10;                     
probs = binopdf(p,n,k) %making an array of all the different probabilities

%Exercise 2
N = 14;                       
k = 8;                        
prob1  = binopdf(k,N,0.1)     %calculate all of the differnt probabilities 
prob2  = binopdf(k,N,0.2)     
prob3  = binopdf(k,N,0.3)     
prob4  = binopdf(k,N,0.4)     
prob5  = binopdf(k,N,0.5)      
prob6  = binopdf(k,N,0.6)   % p = 0.2066, most likely of the group  
prob7  = binopdf(k,N,0.7)     
prob8  = binopdf(k,N,0.8)     
prob9  = binopdf(k,N,0.9)     
prob10 = binopdf(k,N,1.0)

%% Exercise 3 - Bonus Code is The NGG Statistics Program Repository code created by Josh Gold
